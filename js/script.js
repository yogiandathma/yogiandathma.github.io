			...
			$("#location").show(0,function(){
				$("#location_map").gMap({
			 			...
			 			[
			 				{
                 				latitude: 42.367997, 
                 				longitude: -71.070776, 
                 				html: "<strong>The Ceremony and Reception</strong><br/>Museum of Science<br/>Boston, MA<br/><strong>GPS:</strong> 42.367997, -71.070776", 
                				popup: true,               
							},
							{
                				latitude: 42.359051, 
                 				longitude: -71.094664, 
                 				html: "<strong>Welcome Dinner</strong><br/>Twenty Chimneys Room, Stratton Student Center<br/>Massachusetts Avenue, Cambridge, MA<br/><strong>GPS:</strong> 42.359051, -71.094664", 
                 				popup: true,               
                    		} 
                		], 
             		panControl: true, 
            		...
            		streetViewControl: true, 
             		scrollwheel: false, 
             		styles: [ { "stylers": [ { "hue": "##0066ff" }, { "gamma": 1 }, { "saturation": -60 } ] } ], 
             		onComplete: function() {
