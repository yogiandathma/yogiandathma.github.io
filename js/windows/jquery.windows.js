        ...
        if(options.snapping){
            t = setTimeout(function(){
                ...
                var $visibleWindow = _getCurrentWindow(); // visible window
					...
					//Additional code to declare scrollTo variable for top bar version
					if ($("body").hasClass("top-bar")){
	                    var scrollTo = $visibleWindow.offset().top - $("#logo").innerHeight(); // top of visible window
					}
					else
					{
						//This is the default variable from plugin
                ...
                $('html:not(:animated),body:not(:animated)').animate({
						...
						start:
							//Additional code to disable mousewheel before snapping	
							function(){
								/*$('body, html').on({
						...
						complete:
							...
							//Additional code to enable mousewheel after snapping	
							//======================================================				
